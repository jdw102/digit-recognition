...
from src.analysis import generate_log_likelihood_analysis, generate_mfccs_analysis, generate_confusion_matrix, \
    ...
    generate_cluster_number_analysis, generate_frame_sampling_analysis
...
# mfcc_indices = [4, 2, 1, 7, 9, 10, 6, 8, 11, 12]
mfcc_indices = [4, 2, 1, 7, 9, 5, 6, 10, 8, 11]
# sampling_rate = 1
# cov = Cov.FULL
# method = Method.E_M
# test_data_type = "test"
...
if __name__ == "__main__":
    ...
    generate_frame_sampling_analysis(training_data, test_data, phoneme_nums, method, cov, mfcc_indices)
    print("Done!")
